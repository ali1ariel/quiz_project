defmodule QuizProjectWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(QuizProjectWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(QuizProjectWeb.Gettext, "errors", msg, opts)
    end
  end
