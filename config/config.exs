...
config :quiz_project,
  ...
  ash_domains: [QuizProject.Accounts],
...
config :quiz_project, QuizProjectWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: QuizProjectWeb.ErrorHTML, json: QuizProjectWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: QuizProject.PubSub,
  live_view: [signing_salt: "dnbWL75o"]
